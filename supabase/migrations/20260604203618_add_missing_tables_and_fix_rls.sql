/*
  ...
  ## Changes
  1. New Tables: saved_jobs, payments, reports, admin_logs, skills, portfolio_projects
  2. Added username auto-generation on profile creation
  3. Added full-text search index on jobs
  4. Fixed profiles RLS to allow unauthenticated reads of public data
  5. Added freelancer_profiles auto-creation trigger
*/
...
CREATE TABLE IF NOT EXISTS admin_logs (
  ...
  target_type text, -- 'user', 'job', 'verification', etc.
  target_id uuid,
...
-- ============================================================
-- ENHANCED PROFILES: fix handle_new_user to generate username
-- ============================================================
...
DECLARE
  ...
  counter integer := 0;
BEGIN
  -- Generate base username from full_name or email
